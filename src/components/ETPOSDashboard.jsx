    ...
    <div className="etpos-dashboard">
      ...
      <header className="etpos-header">
        ...
        <div className="header-right">
          <button className="header-btn calendar-btn">
            📅 Calendar
          </button>
          <button className="header-btn todo-btn">
            ➕ Add To Do
          </button>
          <button className="header-btn tour-btn">
            🎯 Application Tour
          </button>
          <button className="header-btn calculator-btn">
            🧮 Calculator
          </button>
          <button className="header-btn profit-btn">
            💰 Today's Profit
          </button>
          <div className="notification-section">
            ...
            <span className="notification-date">11/11/2025</span>
          </div>
