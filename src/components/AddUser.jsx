  ...
  return (
    <div className="add-user-container">
      ...
      <form id="userForm" onSubmit={handleSubmit} className="add-user-form">
        ...
        <div className="card shadow-sm mt-3">
          ...
          <div className="card-body">
            <div className="row g-3">
              <div className="col-md-6">
                <div className="mb-3">
                  <label className="form-label small fw-medium text-muted d-block mb-1">Department *</label>
                  <select
                    className="form-select form-select-sm"
                    name="department"
              ...
              <div className="col-md-6">
                <div className="mb-3">
                  <label className="form-label small fw-medium text-muted d-block mb-1">Designation *</label>
                  <select
                    className="form-select form-select-sm"
                    name="designation"
        ...
        <div className="add-user-footer card shadow-sm mt-3">
